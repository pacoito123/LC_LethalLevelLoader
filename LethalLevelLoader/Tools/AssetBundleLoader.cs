...
namespace LethalLevelLoader
{
    public class AssetBundleLoader : MonoBehaviour
    {
        ...
        internal static void NetworkRegisterCustomContent(NetworkManager networkManager)
        {
            ...
            {
                // Allow v73 bundles with a missing DungeonFlow field to not softlock the game, while also registering indoor hazards:
                extendedMod.ExtendedDungeonFlows.RemoveAll(extendedDungeonFlow => !NetworkRegisterDungeonContent(extendedDungeonFlow, networkManager));
        ...
        */
        ...
        internal static void CreateVanillaExtendedLevels(StartOfRound startOfRound)
        {
            ...
            foreach (SelectableLevel selectableLevel in startOfRound.levels)
            {
                ...
                extendedLevel.UseTerrainFootsteps = selectableLevel.name.StartsWith("Vow", StringComparison.Ordinal)
